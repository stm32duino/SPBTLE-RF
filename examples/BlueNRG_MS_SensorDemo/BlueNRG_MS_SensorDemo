/*
 ...
 BlueNRG_MS_SensorDemo

 This sketch provides a default example how to use the X_NUCLEO_IDB05A1
 (BlueNRG-MS expansion board) on top of an STM32 Nucleo board.
...
/* Configure BTLE_SPI
  MOSI: IDB0XA1_PIN_SPI_MOSI
  MISO: IDB0XA1_PIN_SPI_MISO
  SCLK: IDB0XA1_PIN_SPI_SCK
  */
